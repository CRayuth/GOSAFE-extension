(() => {
  ...
  /** @typedef {{ id: string, ts: number, kind: string, title: string, detail?: string, host?: string, count?: number, ruleset?: string, source?: string, initiator?: string, url?: string, type?: string }} ActivityEntry */
  ...
  class ActivityLogStore {
     ...
     * @param {{ url?: string, initiator?: string, rulesetId?: string, source?: string, type?: string }} info
     */
